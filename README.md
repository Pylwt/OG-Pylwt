...
HubsSection:NewButton("Pendulum Hub", "Click to open hub", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Tescalus/Pendulum-Hubs-Source/main/Pendulum%20Hub%20V5.lua%22))()
end)
...
local CreditsSection = Credits:NewSection("Last Update: 19th Of November 2022")
local CreditsSection = Credits:NewSection("Version: 3.6a")
