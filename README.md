...
HubsSection:NewButton("RGB Pylwt Hub", "Click to open hub", function()
...
local PremiumSection = Premium:NewSection("Buy Pylwt Premium In Our Discord Server")
...
PremiumSection:NewButton("Pylwt Admin Commands", "Enter A Correct Key First", function()
    pcall(loadstring(game:HttpGet("https://pastebin.com/raw/2wgbZ6Xd")))
end)
...
local CreditsSection = Credits:NewSection("Version: 2.18a")
