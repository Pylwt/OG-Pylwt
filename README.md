...
MainSection:NewButton("Aimbot V1", "Click to get tool", function()
...
MainSection:NewButton("Aimbot V2", "Click to get tool", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Exunys/Aimbot-Script/main/Aimbot%20Script.lua", true))()
end)
MainSection:NewButton("Silent Aim", "Click to get tool", function()
