...
HubsSection:NewButton("Top 3k Hub", "Click to open hub", function()
...
local CreditsSection = Credits:NewSection("Discord: @Cosmos#6567")
...
local CreditsSection = Credits:NewSection("Last Update: 29th Of July 2022")
local CreditsSection = Credits:NewSection("Version: 3.1a")
